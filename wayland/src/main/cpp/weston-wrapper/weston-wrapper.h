...
EXPORT void wrapper_func_pointer(void* jni, android_pointer func);

EXPORT void wrapper_func_button(void* jni, android_button func);

EXPORT void wrapper_func_axis(void* jni, android_axis func);
